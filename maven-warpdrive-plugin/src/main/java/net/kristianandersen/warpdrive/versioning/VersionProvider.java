...
public class VersionProvider {
     ...
     *
     * @param mojo The WarpDrive plugin
     * @return A suitable implementation of {@linkplain net.kristianandersen.warpdrive.versioning.AbstractVersionGenerator}
     ...
     * Projects using SVN should use {@linkplain net.kristianandersen.warpdrive.versioning.SvnRevNumberGenerator}
     *
     * @param mojo The WarpDrive plugin
